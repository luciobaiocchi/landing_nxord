          ...
          <Col lg={10} xl={8} className="pt-5 mt-4">
            ...
            <div className="card text-start" style={{ padding: 'clamp(24px, 5vw, 48px)', borderTop: '4px solid var(--color-brand)' }}>
              ...
              <section className="mb-0">
                ...
                <p className="mb-0">
                  Per qualsiasi domanda riguardante questi Termini, si prega di contattarci all'indirizzo email: <a href="mailto:thomaskellywork24@gmail.com" style={{ color: 'var(--color-heading)', fontWeight: 500 }}>thomaskellywork24@gmail.com</a>
                </p>
              </section>
            </div>
          </Col>
