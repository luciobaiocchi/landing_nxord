          ...
          <Col lg={10} xl={8} className="pt-5 mt-4">
            ...
            <div className="card text-start" style={{ padding: 'clamp(24px, 5vw, 48px)', borderTop: '4px solid var(--color-brand)' }}>
              ...
              <section className="mb-0">
                ...
                <p className="mb-3">
                  Per qualsiasi domanda o per esercitare i tuoi diritti, puoi scriverci a: <a href="mailto:thomaskellywork24@gmail.com" style={{ color: 'var(--color-heading)', fontWeight: 500 }}>thomaskellywork24@gmail.com</a>.
                </p>
                <p className="mb-0">
